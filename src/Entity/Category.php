...
class Category
{
    ...
    #[ORM\OneToMany(mappedBy: 'category', targetEntity: Wish::class, orphanRemoval: false)]
    ...
    public function getWishes(): Collection { return $this->wishes; }
    ...
    {
        if ($this->wishes->removeElement($wish) && $wish->getCategory() === $this) {
